...
export function RubyBenefitsSection() {
  return (
    <section className="relative w-full bg-white py-24 md:py-28 lg:py-32 overflow-hidden">
      {/* Background Accent */}
      <div className="absolute inset-0 bg-[#071F5B]" />
      <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-pink-500/20 blur-[160px]" />
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-teal-400/20 blur-[140px]" />

      {/* Content */}
      <div className="relative max-w-7xl mx-auto px-6 md:px-10 lg:px-12 space-y-24 md:space-y-32">
        {/* ===== HERO BENEFIT ===== */}
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <div className="text-white space-y-8 max-w-xl">
            <h2 className="text-4xl md:text-5xl lg:text-6xl leading-tight font-semibold text-white">
              Take back hours
              <br />
              in your day.
            </h2>
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-white/90">
              ...
              <strong>10+ hours every month</strong> by handing off calls to
              real, trained professionals with confidence.
            </p>
          </div>
        ...
        >
          ...
          {/* Text */}
          <div className="text-white space-y-6 max-w-xl order-1 lg:order-2">
            ...
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-white/90">
              Callers reach a real person every time, and our average answer
              time is <strong>under ten seconds</strong>.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="text-white space-y-6 max-w-xl">
            ...
            <p className="text-lg md:text-xl lg:text-2xl leading-relaxed text-white/90">
              ...
              <strong>1.6 million leads each year</strong> for businesses of
              every size, from law firms to startups.
            </p>
          </div>
